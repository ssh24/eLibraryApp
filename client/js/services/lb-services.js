 ...
 */
  module.factory(
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/Clients/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Client.books.findById() instead.
            "prototype$__findById__books": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Clients/:id/books/:fk",
              method: "GET",
            },

            // INTERNAL. Use Client.books.destroyById() instead.
            ...
            // INTERNAL. Use Client.books.updateById() instead.
            ...
            // INTERNAL. Use Client.books() instead.
            "prototype$__get__books": {
              isArray: true,
              url: urlBase + "/Clients/:id/books",
              method: "GET",
            },

            // INTERNAL. Use Client.books.create() instead.
            "prototype$__create__books": {
              url: urlBase + "/Clients/:id/books",
              method: "POST",
            },

            // INTERNAL. Use Client.books.destroyAll() instead.
            "prototype$__delete__books": {
              url: urlBase + "/Clients/:id/books",
              method: "DELETE",
            },

            // INTERNAL. Use Client.books.count() instead.
            "prototype$__count__books": {
              url: urlBase + "/Clients/:id/books/count",
              method: "GET",
            },
            ...
            // INTERNAL. Use Book.clients() instead.
            "::get::Book::clients": {
              url: urlBase + "/Books/:id/clients",
              method: "GET",
            },

            // INTERNAL. Use Book.clients.create() instead.
            "::create::Book::clients": {
              url: urlBase + "/Books/:id/clients",
              method: "POST",
            },

            // INTERNAL. Use Book.clients.createMany() instead.
            "::createMany::Book::clients": {
              isArray: true,
              url: urlBase + "/Books/:id/clients",
              method: "POST",
            },

            // INTERNAL. Use Book.clients.update() instead.
            "::update::Book::clients": {
              url: urlBase + "/Books/:id/clients",
              method: "PUT",
            },

            // INTERNAL. Use Book.clients.destroy() instead.
            "::destroy::Book::clients": {
              url: urlBase + "/Books/:id/clients",
              method: "DELETE",
            },
    ...
    /**
     * @ngdoc object
     * @name lbServices.Client.books
     * @header lbServices.Client.books
     * @object
     * @description
     *
     * The object `Client.books` groups methods
     * manipulating `Book` instances related to `Client`.
     *
     * Call {@link lbServices.Client#books Client.books()}
     ...
     */
        ...
        R.books = function() {
          ...
          var action = TargetResource["::get::Client::books"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Client.books#count
             * @methodOf lbServices.Client.books
             *
             * @description
             *
             * Counts books of Client.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - User id
        ...
        R.books.count = function() {
          var TargetResource = $injector.get("Book");
          var action = TargetResource["::count::Client::books"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Client.books#create
             * @methodOf lbServices.Client.books
             *
             * @description
             *
        ...
        R.books.create = function() {
          var TargetResource = $injector.get("Book");
          var action = TargetResource["::create::Client::books"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Client.books#createMany
             * @methodOf lbServices.Client.books
             *
             * @description
             *
        ...
        R.books.createMany = function() {
          var TargetResource = $injector.get("Book");
          var action = TargetResource["::createMany::Client::books"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Client.books#destroyAll
             * @methodOf lbServices.Client.books
             *
             * @description
             *
        ...
        R.books.destroyAll = function() {
          var TargetResource = $injector.get("Book");
          var action = TargetResource["::delete::Client::books"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Client.books#destroyById
             * @methodOf lbServices.Client.books
             *
             * @description
             *
        ...
        R.books.destroyById = function() {
          var TargetResource = $injector.get("Book");
          var action = TargetResource["::destroyById::Client::books"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Client.books#findById
             * @methodOf lbServices.Client.books
             *
             * @description
             *
        ...
        R.books.findById = function() {
          var TargetResource = $injector.get("Book");
          var action = TargetResource["::findById::Client::books"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Client.books#updateById
             * @methodOf lbServices.Client.books
             *
             * @description
             *
        ...
        R.books.updateById = function() {
          var TargetResource = $injector.get("Book");
          var action = TargetResource["::updateById::Client::books"];
          return action.apply(R, arguments);
        };
 ...
 */
  module.factory(
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/Books/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Book.clients.update() instead.
            "prototype$__update__clients": {
              url: urlBase + "/Books/:id/clients",
              method: "PUT",
            },

            // INTERNAL. Use Book.clients.destroy() instead.
            "prototype$__destroy__clients": {
              url: urlBase + "/Books/:id/clients",
              method: "DELETE",
            },
            ...
            // INTERNAL. Use Client.books.createMany() instead.
            "::createMany::Client::books": {
              isArray: true,
              url: urlBase + "/Clients/:id/books",
              method: "POST",
            },
    ...
    /**
     * @ngdoc object
     * @name lbServices.Book.clients
     * @header lbServices.Book.clients
     * @object
     * @description
     *
     * The object `Book.clients` groups methods
     * manipulating `Client` instances related to `Book`.
     *
     * Call {@link lbServices.Book#clients Book.clients()}
     * to query all related instances.
     */
             ...
             * @description
             *
             * Fetches hasOne relation clients.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.clients = function() {
          ...
          var action = TargetResource["::get::Book::clients"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Book.clients#create
             * @methodOf lbServices.Book.clients
             *
             * @description
             *
        ...
        R.clients.create = function() {
          var TargetResource = $injector.get("Client");
          var action = TargetResource["::create::Book::clients"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Book.clients#createMany
             * @methodOf lbServices.Book.clients
             *
             * @description
             *
        ...
        R.clients.createMany = function() {
          var TargetResource = $injector.get("Client");
          var action = TargetResource["::createMany::Book::clients"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Book.clients#destroy
             * @methodOf lbServices.Book.clients
             *
             * @description
             *
             * Deletes clients of this model.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             * This method returns no data.
             */
        R.clients.destroy = function() {
          var TargetResource = $injector.get("Client");
          var action = TargetResource["::destroy::Book::clients"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Book.clients#update
             * @methodOf lbServices.Book.clients
             *
             * @description
             *
             * Update clients of this model.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             * </em>
             */
        R.clients.update = function() {
          var TargetResource = $injector.get("Client");
          var action = TargetResource["::update::Book::clients"];
          return action.apply(R, arguments);
        };
